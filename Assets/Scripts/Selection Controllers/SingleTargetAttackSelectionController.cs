...
public class SingleTargetAttackSelectionController : AttackSelectionController
{
    ...
    public override void OnUnitMouseUp(UnitController uc)
    {
        ...
        {
            if (tc.tile.unit == uc.unit && uc.unit.team != sm.selectedUnit.unit.team)
            {
    ...
    {
        return new SingleTargetAttackSelectionController();
    }
}
